  ...
  const columns: ColumnDef<Ticket>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold ${colors[status]}`}>
            {status}
          </span>
        )
      }
    ...
    },
    {
      ...
      cell: () => (
        <div className="flex justify-end gap-2">
          <button className="text-xs bg-blue-50 text-blue-600 dark:bg-blue-900/20 dark:text-blue-400 px-3 py-1 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/40 flex items-center gap-1 transition-colors">
