...
const TicketSchema = new mongoose_1.Schema({
    ...
    submittedBy: { type: mongoose_1.Schema.Types.ObjectId, required: true, refPath: 'userModel' },
    ...
    messages: [{
            sender: { type: mongoose_1.Schema.Types.ObjectId, required: true, refPath: 'messages.senderModel' },
